...
task.spawn(function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/chocolascript-glitch/Chocola-Desync-PC/refs/heads/main/Chocola-Desync-ONLY-PC"))()
end)
